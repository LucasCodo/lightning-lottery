...
def get_invoice(num_satoshis=2,memo='{02,13,22,44,55,59}, luss1010@gmail.com'):
    my_wallet = LNPayWallet(wallet_id)
    invoice_params = {
...
def get_transactions():
    my_wallet = LNPayWallet(wallet_invoice)
    transactions = my_wallet.get_transactions()
    return transactions
def get_info():
    my_wallet = LNPayWallet(wallet_read)
